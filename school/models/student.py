...
class StudentStudent(models.Model):
    ...
    reg_code = fields.Char(string="R-Code", help="Student Registration Code")
    reg_no = fields.Char(string="Registration No.", help="Student Registration Code")
    ...
    roll_no = fields.Integer("Roll No.", help="Enter student roll no.")
    ...
    en_name = fields.Char("Student name")
    last = fields.Char(
        "Surname",
        required=False,
    ...
    father_name =  fields.Char(
        "Father Name",
        help="Enter Father Name",
    )

    en_father_name = fields.Char(
        "Father Name",
        help="Enter Father Name",
    )
    ...
    gender = fields.Selection(
        ...
        help="Select student gender",default='female'
    )
    ...
    parent_name_address = fields.Char("Parent's name and Address")
    adhar_no = fields.Char("Aadhaar No.")
    student_dep = fields.Selection([('urdu', 'Urdu'), ('arabic', 'Arabic')], string='شعبه')
    student_dis = fields.Selection([('y', 'غير مستطيع'), ('n', 'مستطيع')], string='مستطيع/غير مستطيع')
    occupation = fields.Char("Occupation")
    parent_relation = fields.Char("Relation")
    prev_school = fields.Char()
    reason_leave_prev_school = fields.Char()
    prv_class = fields.Many2one('standard.standard')
